...
{
    public partial class MPackAndPartList : StrapSubForm_OnlyOneGrid_V2
    {
        private MebLotArgs _mebLotArgs;
        private MebLotPocket _mebLotPocket;

        public MPackAndPartList()
        {
            InitializeComponent();
        }

        public MPackAndPartList(MebLotArgs mebLotArgs, MebLotPocket mebLotPocket) : this()
        {
        ...
        public override void InitStrap()
        {
            ...
            InitFields(new FieldArgs_StrapSubForm_OnlyOneGrid
            {
                ...
                GridView = gridView1,
                InitModelType = typeof(MPackAndPartLotModel),
                ModelArgs = _mebLotArgs.MebLotModelArgs,
                StrapEditMode = StrapEditMode.Default
            });
            InitPocketDelegate<MebLotModelArgs, MPackAndPartLotModel>(_mebLotPocket.SelectMPackAndPartLotModels, null);
