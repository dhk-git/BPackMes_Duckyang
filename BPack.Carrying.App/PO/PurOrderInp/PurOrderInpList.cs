...
{
    public partial class PurOrderInpList : StrapSubForm_OnlyOneGrid_V2
    {
        private PurOrderInpArgs _purOrderInpArgs;
        private PurOrderInpPocket _purOrderInpPocket;

        public PurOrderInpList()
        {
            InitializeComponent();
        }

        public PurOrderInpList(PurOrderInpArgs purOrderInpArgs, PurOrderInpPocket purOrderInpPocket) : this()
        {
        ...
        public override void InitStrap()
        {
            ...
            InitFields(new FieldArgs_StrapSubForm_OnlyOneGrid {
                ...
                GridView = gridView1,
                InitModelType = typeof(PurOrderInpModel),
                ModelArgs = _purOrderInpArgs.PurOrderInpModelArgs,
                StrapEditMode = StrapEditMode.Default
            });
            InitPocketDelegate<PurOrderInpModelArgs, PurOrderInpModel>(_purOrderInpPocket.SelectPurOrderInpModels, null);
        }
    }
}
