...
{
    public partial class AppHistApprovalMain : StrapMainForm
    {
        ...
        public override void InitStrap()
        {
            ...
            _AppHistArgs.AppHistModelArgs.Select_Main_Opt = "2";
            ...
            */
            ...
            LookUpEditHelper.SetSysCode(lueINSP_APP_STATUS, "INSP_APP_STATUS");
        ...
        {
            ShowApproval(AppHistApproval.APP_STATUS.APP);
        }

        private void btnReturn_Click(object sender, EventArgs e)
        {
            ShowApproval(AppHistApproval.APP_STATUS.RET);
        }

        private void ShowApproval(AppHistApproval.APP_STATUS status)
        {
            try
            {
                ...
                AppHistApproval _appHistApproval = new AppHistApproval(status, (List<AppHistHeaderModel>)checkedModels);

                if (_appHistApproval.ShowDialog() == DialogResult.OK)
                {
                    RefreshAppHistHeader();
                }
            }
