...
namespace BPack.CommonMes.IO.SerialComm
{
    public class SerialComm
    {
        ...
        public string OpenComm(string portName, int baudrate, int databits, StopBits stopbits, Parity parity, Handshake handshake = Handshake.None)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return "open failed(" + portName + "), " + ex.Message + "\r\n";
            }
        }
