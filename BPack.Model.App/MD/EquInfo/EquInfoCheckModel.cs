...
{
    public class EquInfoCheckModel : ModelBase_CommonColumns_With_DelFlag
    {
        [ReadOnly(true)]
        [Key]
        ...
        [Display(Name = "조건코드")]
        [StrapMinWidth(100)]
        public string EQUIP_CHK_CD { get; set; }
        [Display(Name = "조건명")]
        [StrapMinWidth(150)]
        public string EQUIP_CHK_NM { get; set; }
        [Display(Name = "PLC맵핑코드")]
        [StrapMinWidth(120)]
        public string PLC_MAP_CD { get; set; }
