...
{
    public class ItemConvModel : ModelBase_CommonColumns_With_DelFlag
    {
        [ReadOnly(true)]
        [Key]
        ...
        [Key]
        [StrapVisible(false, false, false)]
        public string CONV_CD_KEY { get; set; }
        [ReadOnly(true)]
        [Display(Name = "회사코드")]
        [StrapVisible(false, false, false)]
        ...
        [Display(Name = "환산코드")]
        public string CONV_CD { get; set; }
        [Display(Name = "환산명")]
        public string CONV_NM { get; set; }
        [Display(Name = "대상단위")]
