...
{
    public class PrdWcOperWorkCenterModel : ModelBase_CommonColumns_With_DelFlag
    {
        [ReadOnly(true)]
        [Key]
        ...
        [Display(Name = "자재투입창고(라우팅생성시기준")]
        [StrapVisible(false, false, false)]
        public string MAT_WH_CD { get; set; }
        [Display(Name = "자재투입위치(라우팅생성시기준")]
        [StrapVisible(false, false, false)]
        public string MAT_LOC_CD { get; set; }
        [Display(Name = "생산입고창고(라우팅생성시기준")]
        [StrapVisible(false, false, false)]
        public string GD_WH_CD { get; set; }
        [Display(Name = "생산입고위치(라우팅생성시기준")]
        [StrapVisible(false, false, false)]
